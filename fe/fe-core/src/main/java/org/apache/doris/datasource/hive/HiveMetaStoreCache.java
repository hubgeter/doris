...
public class HiveMetaStoreCache {
     ...
     **/
    private void init() {
        CacheFactory<PartitionValueCacheKey, HivePartitionValues> partitionValuesCacheFactory = new CacheFactory(
    ...
    private FileCacheValue getFileCache(String location, String inputFormat,
        ...
        try {
            RemoteIterator<RemoteFile> iterator = directoryLister.listFiles(fs, false,
                    table, location);
